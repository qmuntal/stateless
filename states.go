...
func (sr *stateRepresentation[_, T]) CanHandle(ctx context.Context, trigger T, args ...any) (ok bool) {
...
func (sr *stateRepresentation[S, _]) Activate(ctx context.Context) error {
...
func (sr *stateRepresentation[S, _]) Deactivate(ctx context.Context) error {
...
func (sr *stateRepresentation[_, T]) PermittedTriggers(ctx context.Context, args ...any) (triggers []T) {
	var unmet []string
...
func (sr *stateRepresentation[S, _]) executeActivationActions(ctx context.Context) error {
...
func (sr *stateRepresentation[S, _]) executeDeactivationActions(ctx context.Context) error {
