...
func Example() {
	...
	phoneCall.Configure(stateRinging).OnEntryFrom(triggerCallDialed, func(_ context.Context, _ stateless.Transition, args ...interface{}) error {
		onDialed(args[0].(string))
		return nil
	}).Permit(triggerCallConnected, stateConnected)

	phoneCall.Configure(stateConnected).OnEntry(func(_ context.Context, _ stateless.Transition, _ ...interface{}) error {
		startCallTimer()
		return nil
	}).OnExit(func(_ context.Context, _ stateless.Transition, _ ...interface{}) error {
		stopCallTimer()
		return nil
	}).InternalTransition(triggerMuteMicrophone, func(_ context.Context, _ stateless.Transition, _ ...interface{}) error {
		onMute()
		return nil
	}).InternalTransition(triggerUnmuteMicrophone, func(_ context.Context, _ stateless.Transition, _ ...interface{}) error {
		onUnmute()
		return nil
	}).InternalTransition(triggerSetVolume, func(_ context.Context, _ stateless.Transition, args ...interface{}) error {
